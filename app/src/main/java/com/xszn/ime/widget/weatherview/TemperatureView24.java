...
public class TemperatureView24 extends View {
    ...
    public TemperatureView24(Context context) {
        this(context, null);
    }

    public TemperatureView24(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TemperatureView24(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }

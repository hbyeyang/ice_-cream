...
public class CustomIndicatorView extends LinearLayout {
    ...
    private static final int DEFAULT_INDICATOR_NORMAL_RESID = R.mipmap.ic_page_indicator;
    private static final int DEFAULT_INDICATOR_SELECTED_RESID = R.mipmap.ic_page_indicator_focused;

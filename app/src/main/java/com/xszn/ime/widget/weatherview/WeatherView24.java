...
public class WeatherView24 extends HorizontalScrollView {
    ...
    public WeatherView24(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public WeatherView24(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (getChildCount() > 0) {
            ...
            if (root.getChildCount() > 0) {
                ...
                WeatherItemView24 c = (WeatherItemView24) root.getChildAt(0);
                int dX = c.getTempX();
                int dY = c.getTempY();
                int nX = c.getTempX();
                int nY = c.getTempY();
                ...
                TemperatureView24 tv = (TemperatureView24) c.findViewById(R.id.ttv_day24);
                ...
                if (lineType == LINE_TYPE_CURVE) {
                    ...
                    for (int i = 0; i < lineSize; i++) {
                        ...
                        if (Float.isNaN(currentPointX)) {
                            WeatherItemView24 curWI = (WeatherItemView24) root.getChildAt(i);
                            ...
                            TemperatureView24 tempV = (TemperatureView24) curWI.findViewById(R.id.ttv_day24);
                            tempV.setRadius(10);
                        ...
                        if (Float.isNaN(previousPointX)) {
                            if (i > 0) {
                                WeatherItemView24 preWI = (WeatherItemView24) root.getChildAt(Math.max(i-1, 0));
                                ...
                                TemperatureView24 tempV0 = (TemperatureView24) preWI.findViewById(R.id.ttv_day24);
                                tempV0.setRadius(10);
                        ...
                        if (Float.isNaN(prePreviousPointX)) {
                            if (i > 1) {
                                ...
                                WeatherItemView24 preWI = (WeatherItemView24) root.getChildAt(Math.max(i-2, 0));
                        ...
                        if (i < lineSize - 1) {
                            ...
                            WeatherItemView24 nextWI = (WeatherItemView24) root.getChildAt(Math.min(root.getChildCount()-1, i + 1));
                            ...
                            TemperatureView24 tempV1 = (TemperatureView24) nextWI.findViewById(R.id.ttv_day24);
                    ...
                    for (int i = 0; i < root.getChildCount() - 1; i++) {
                        WeatherItemView24 child = (WeatherItemView24) root.getChildAt(i);
                        WeatherItemView24 child1 = (WeatherItemView24) root.getChildAt(i + 1);
                        ...
                        TemperatureView24 tempV = (TemperatureView24) child.findViewById(R.id.ttv_day24);
                        TemperatureView24 tempV1 = (TemperatureView24) child1.findViewById(R.id.ttv_day24);
    ...
    public void setList(final List<WeatherModel24> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            WeatherModel24 model = list.get(i);
            final WeatherItemView24 itemView = new WeatherItemView24(getContext());
    ...
    private static class NightTempComparator implements Comparator<WeatherModel24> {

        @Override
        public int compare(WeatherModel24 o1, WeatherModel24 o2) {
    ...
    public interface OnWeatherItemClickListener {
        void onItemClick(WeatherItemView24 itemView, int position, WeatherModel24 weatherModel);
    }
